...
//                    'altHeader' => 1,
    ...
    'sbarflags' => array (
        'name'    =>  'Simple Sorted Bars with flags',
        'displayName'   =>  'Bar chart',
        'dev'     =>  'Simple bar charts to display data for a single indicators. Countries are sorted in descending order. The latest available year used to render chart.',
        'image'   =>  'SimpleBar.png',
        'options' =>  array (
    ...
    'sbardiamond' => array (
        'name'    =>  'Bars Diamonds',
        'displayName'   =>  'Bar chart',
        'dev'     =>  'A bar chart with diamonds for additional series. Countries are displayed in the order of data input.',
    ...
    'sstackedbar' => array (
        'name'    =>  'Stacked Bars',
        'displayName'   =>  'Bar chart',
        'dev'     =>  'A stacked bar chart to show composite indicators for different countries.',
        'image'   =>  'SimpleBarsDiamonds.png',
        'options' =>  array (
                    'chartType' => 'simpleChart',
                    'altHeader' => 1,
